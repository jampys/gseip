                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="<?php echo (PrivilegedUser::dhasPrivilege('GRV_VER', array(1)) )? '': 'disabled' ?>"><a href="index.php?action=vto_gruposVehiculos"><i class="fas fa-users fa-sm fa-fw dp_blue"></i>&nbsp;Flotas de vehículos</a></li>
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown profile">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="#"><i class="fas fa-user dp_blue"></i>&nbsp;Mi perfil</a></li>
                            <li role="separator" class="divider"></li>
                            <li><a href="index.php?action=login&operation=salir"><span class="glyphicon glyphicon-log-out dp_blue"></span> Cerrar sesión</a></li>
                        </ul>
