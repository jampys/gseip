...
switch ($operation)
{
    case 'refreshGrid':
        ...
        $filtro_contrato = ($_POST['id_contrato']!='')? 1 : 0;

        $rta = $view->capacitaciones = Capacitacion::getCapacitaciones($periodo, $id_categoria, $mes_programada, $id_contrato, $filtro_contrato);
