...
switch ($operation)
{
    ...
    case 'editTarea': //ok
        ...
        $view->label = ($_POST['target']!='view')? '<span class="glyphicon glyphicon-edit" aria-hidden="true"></span> '.$view->tarea->getNombre() : '<i class="far fa-sticky-note"></i> '.$view->tarea->getNombre();
