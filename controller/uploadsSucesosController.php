...
switch ($operation) {
    ...
    case 'upload': //ok
        ...
        $id = $_POST['id']; //con este id (id_suceso) hago el insert de los uploads en la BD
        ...
        if(isset($_FILES["myfile"])) {
            ...
            if(!is_array($_FILES["myfile"]["name"])) //single file
            {
                ...
                if(move_uploaded_file($_FILES["myfile"]["tmp_name"], $output_dir . $newfilename))
                    Suceso::uploadsUpload($output_dir, $newfilename, $id); //inserta en la BD
                $ret[]= $newfilename;
            }
    ...
    case 'delete': //ok
        ...
        if( isset($_POST['name'])) {
            ...
            if (file_exists($filePath)) {
                unlink($filePath);
                Suceso::uploadsDelete($fileName); //Borra el registro de la BD
            }
        }
