...
class EvaluacionAspectoGeneral
{
    private $id_evaluacion_aspecto_general;
    private $id_aspecto_general;
    private $id_puntaje_aspecto_general;
    private $fecha;
    ...
    // GETTERS
    function getIdEvaluacionAspectoGeneral()
    { return $this->id_evaluacion_aspecto_general;}

    function getIdAspectoGeneral()
    { return $this->id_aspecto_general;}

    function getIdPuntajeAspectoGeneral()
    { return $this->id_puntaje_aspecto_general;}
    ...
    //SETTERS
    function setIdEvaluacionAspectoGeneral($val)
    { $this->id_evaluacion_aspecto_general=$val;}

    function setIdAspectoGeneral($val)
    { $this->id_aspecto_general=$val;}

    function setIdPuntajeAspectoGeneral($val)
    { $this->id_puntaje_aspecto_general=$val;}
    ...
    public static function getAspectosGenerales($id_empleado, $periodo) { //ok
...
where em.id_empleado = :id_empleado";
    ...
    public function updateEvaluacionAspectoGeneral(){ //ok
    ...
    private function insertEvaluacionAspectoGeneral(){ //ok
