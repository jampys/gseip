            ...
            <?php if(isset($view->evaluaciones)) {
             foreach ($view->evaluaciones as $evaluacion):   ?>
                <tr id_empleado="<?php echo $evaluacion['id_empleado'];?>"
                    ...
                    <td class="text-center"><a class="loadEac" href="javascript:void(0);" title="Evaluación competencias" ><span class="glyphicon glyphicon-edit <?php echo ($evaluacion['hasAllEac'])? 'text-success': '';  ?>" aria-hidden="true"></span></a></td>
                    <td class="text-center"><a class="loadEao" href="javascript:void(0);" title="Evaluación aspectos generales" ><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a></td>
