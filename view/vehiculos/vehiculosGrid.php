...
<div class="col-md-10">
    ...
    <div style="text-align: right; margin-bottom: 10px">
        <button  id="new" type="button" class="btn btn-default btn-sm" <?php echo ( PrivilegedUser::dhasAction('VEH_INSERT', array(1)) )? '' : 'disabled' ?> >
        ...
        <table id="example" class="table table-striped table-bordered table-condensed" cellspacing="0" width="100%" style="display: none">
            ...
            <?php foreach ($view->vehiculos as $vehiculo):   ?>
                <tr>
                    ...
                    <td class="text-center"><a class="contratos" href="javascript:void(0);" data-id="<?php echo $vehiculo['id_vehiculo'];?>" title="contratos"><i class="fas fa-suitcase dp_brown"></i></a>&nbsp;&nbsp;
                        ...
                        <a class="<?php echo (PrivilegedUser::dhasAction('VEH_UPDATE', array(1)))? 'edit' : 'disabled'; ?>" title="editar" href="javascript:void(0);" data-id="<?php echo $vehiculo['id_vehiculo'];?>"><span class="glyphicon glyphicon-edit dp_yellow" aria-hidden="true"></span></a>&nbsp;&nbsp;
