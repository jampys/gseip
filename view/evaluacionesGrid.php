        ...
        <table id="example" class="table table-striped table-bordered table-condensed" cellspacing="0" width="100%">
            ...
            <?php foreach ($view->evaluaciones as $evaluacion):   ?>
                <tr id_empleado="<?php echo $evaluacion['id_empleado'];?>"
                    ...
                    <td class="text-center"><a class="loadEac" href="javascript:void(0);" title="Evaluación competencias" ><span class="glyphicon glyphicon-edit <?php echo (!$evaluacion['hasAnyEac'])? 'text-danger': 'text-success';  ?>" aria-hidden="true"></span></a></td>
