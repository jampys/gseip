                ...
                foreach ($view->partes as $rp):   ?>
                    <tr data-id="<?php echo $rp['id_parte']; ?>">
                        ...
                        <td style="text-align: center">
                            <?php echo($rp['last_calc_status'])? '<i class="fas fa-car-side fa-fw dp_green" title="parte calculado"></i>':'<i class="fas fa-car fa-fw dp_yellow" title="parte sin calcular"></i>'; ?>&nbsp;&nbsp;
