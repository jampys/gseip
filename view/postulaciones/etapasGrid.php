<table class="table table-condensed dataTable table-hover">
    ...
    <?php foreach ($view->etapas as $et): ?>
        <tr>
            ...
            <td style="text-align: center"><?php echo($et['aplica'] == 1)? '<i class="far fa-thumbs-up fa-fw" style="color: #49ed0e"></i>':'<i class="far fa-thumbs-down fa-fw" style="color: #fc140c"></i>
